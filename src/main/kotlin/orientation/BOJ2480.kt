...
fun main(arg: Array<String>) {
    ...
    if (a == b && a == c) {
        bufferedWriter.append((10000 + a * 1000).toString())
    } else if (a == b || a == c) {
        bufferedWriter.append((1000 + a * 100).toString())
    } else if (b == c) {
        bufferedWriter.append((1000 + b * 100).toString())
    } else {
        bufferedWriter.append((max(max(a, b), c) * 100).toString())
    }
